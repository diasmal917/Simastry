...
struct RacingZodiacLoadingView: View {
    ...
    var body: some View {
        ZStack {
            ...
            RadialGradient(
                colors: [
                    SimastryColor.celestialBlue.opacity(0.32),
            ...
            Text("Simastry")
                ...
                .lineLimit(1)
                .shadow(color: SimastryColor.gold.opacity(glow ? 0.46 : 0.12), radius: glow ? 28 : 10, y: glow ? 8 : 3)
            ...
            if mode == .initialLoading {
                VStack(spacing: 16) {
                    ...
                    SimastryWordmark(font: .system(size: 56, weight: .bold).italic())
                        .shadow(color: SimastryColor.gold.opacity(0.24), radius: 18, y: 6)
