...
nonisolated enum FactoryCompanionCatalog {
    static let all: [FactoryCompanionProfile] = [
        ...
        profile("aries-cassian", "Soren", .aries, "Male", "early 30s", "Oslo", "soren.aries", "Clean nerve, bright spark.", "Soren brings Aries confidence with Nordic cool. His lens is direct, playful, and less interested in pretending than moving.", "Bold, attractive, and quick to act. He helps you stop circling the message and choose the move that has a pulse.", ["bold", "open", "fire"], postCount: 4),
        ...
        profile("pisces-zev", "Zev", .pisces, "Male", "early 30s", "Saint Petersburg", "zev.pisces", "Blue eyes, quiet weather.", "Zev carries Pisces empathy with Russian reserve. He knows when a message needs mercy, music, or silence.", "Cool, soulful, and quietly magnetic. He helps you translate feelings into something another person can hold without losing your edge.", ["reserved", "soulful", "fluid"])
    ]
