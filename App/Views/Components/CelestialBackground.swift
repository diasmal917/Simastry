...
/// mystical starfield (`SpaceWallpaper`) with quiet cosmic dust. The landing
/// screen keeps its own pastel zodiac introduction; from there on the app
...
struct CelestialBackground: View {
    ...
    var body: some View {
        ZStack {
            ...
            CosmicDustLayer(animated: !reduceMotion, moteCount: 34)
                .ignoresSafeArea()
