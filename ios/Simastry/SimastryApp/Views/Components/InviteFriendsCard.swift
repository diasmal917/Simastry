...
/// Invite-a-friend entry point. The reward is honestly framed as a gift to
/// the friend — inviter-side rewards need backend verification and are
        ...
        VStack(alignment: .leading, spacing: 13) {
            HStack(spacing: 10) {
                ...
                VStack(alignment: .leading, spacing: 2) {
                    Text("Give a friend 5 free predictions")
                        .font(SimastryFont.titleSmall)
                        .foregroundStyle(SimastryColor.offWhite)

                    Text("Friends' charts unlock better readings.")
                        .font(SimastryFont.caption)
                        .foregroundStyle(SimastryColor.mutedSilver)
                }
            }

            Text("They get \(AppViewModel.inviteRewardPredictions) free predictions when they join with your link or code.")
            ...
            Text("Inviter rewards coming soon · Gift applies when they sign up")
    ...
    private var compactRow: some View {
        ShareLink(
            ...
            HStack(spacing: 9) {
                ...
                Text("Invite a friend — they get \(AppViewModel.inviteRewardPredictions) free predictions")
        ...
        .buttonStyle(SpringPressStyle())
        .accessibilityLabel("Invite a friend. They get \(AppViewModel.inviteRewardPredictions) free predictions.")
    }
}
