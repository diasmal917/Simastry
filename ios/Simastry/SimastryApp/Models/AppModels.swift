...
nonisolated enum FactoryCompanionCatalog {
    static let all: [FactoryCompanionProfile] = [
        ...
        profile("aries-cassian", "Cassian", .aries, "Male", "early 30s", "Austin", "cassian.aries", "Action first, apology if needed.", "Cassian reads tension like a starting line. His Aries lens is playful, blunt, and allergic to passive waiting.", "Competitive, warm, and kinetic. He helps you stop circling the message and choose the move that has a pulse.", ["bold", "open", "fire"]),
        ...
        profile("gemini-rina", "Rina", .gemini, "Female", "mid 20s", "New York", "rina.gemini", "Three thoughts ahead, still listening.", "Rina makes Gemini feel clever, social, and alive. She catches subtext before it settles into a mood.", "Fast, witty, and charmingly unpredictable. She helps you keep the conversation light without losing the point.", ["witty", "curious", "quick"]),
        ...
        profile("virgo-mara", "Mara", .virgo, "Female", "early 30s", "San Francisco", "mara.virgo", "Precision with a soft landing.", "Mara is Virgo discernment without cruelty. She finds the one sentence that fixes the mess.", "Elegant, observant, and quietly exacting. She helps you edit the message until it becomes both kind and undeniable.", ["precise", "calm", "useful"]),
        ...
        profile("sagittarius-nadia", "Nadia", .sagittarius, "Female", "late 20s", "Los Angeles", "nadia.sagittarius", "Honest, restless, allergic to emotional claustrophobia.", "Nadia brings Sagittarius directness, humor, and space. She keeps the spark alive without over-clutching it.", "Free-spirited, funny, and hard to corner. She helps you choose truth, timing, and enough air for desire to keep moving.", ["open", "funny", "restless"], postCount: 4),
