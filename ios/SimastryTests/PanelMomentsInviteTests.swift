...
struct PanelMomentsInviteTests {
    ...
    private func cleanInviteDefaults() {
        ...
        defaults.removeObject(forKey: AppViewModel.inviteRewardGrantedKey)
    ...
    @Test func applyInviteCodeGrantsOnceAndRejectsOwnCode() {
        cleanInviteDefaults()
